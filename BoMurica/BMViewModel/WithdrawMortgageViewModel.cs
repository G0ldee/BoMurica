...
{
    internal class WithdrawMortgageViewModel : ViewModelBase
    {
        ...
        public WithdrawMortgageViewModel(NavigationStore _navigationStore, Func<AdminHomeViewModel> createClientHomeViewModel)
        {
            ...
            {
                _mortgageList = bomDb.MortgageAccounts.ToList();
            }
            ...
            SignOutPageCommand = new NavigateCommand(_navigationStore, _createHomeViewModel);
